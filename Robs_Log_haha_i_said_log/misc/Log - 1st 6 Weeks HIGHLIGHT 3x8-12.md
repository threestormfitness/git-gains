...
| ----------------------------------------------------------------------- | ------------------------------------------------ | ------- | --------------------------------------- |
| **A1) Straight bar wide grip w/ manpon**                                | Find 1 RM: 305                                   | 3-5 min | 305 lbs + 26 lbs kbs on bands each side |
| **B1) Overhead tricep extensions**                                      | 3x15+ `AMRAP last set`<br>Last set reps here: 34 | 30 sec  | 1 blue + 1 red bands                    |
| **B2) Seated pseudo face pull** `paddle grip`                           | 3x15+ `AMRAP last set`<br>Last set reps here: 42 | 30 sec  | 95 lbs + chain                          |
| **B3) GHD leg curls** `with 2 red bands`                                | 3x15+ `AMRAP last set`<br>Last set reps here: 29 | 60 sec  | 2 bands                                 |
| *Notes: Safety bar at 17 on A1; failed on 325.  Got way too confident.* |                                                  |         |                                         |

### Day 2 (11/30/24)

| Exercise                                                                                    | Sets x Reps/Time | Rest                     | Weight                           |
| ------------------------------------------------------------------------------------------- | ---------------- | ------------------------ | -------------------------------- |
| **A1) Flat Bench Press** `red band around wrist`                                            | 2x3+10; 1x3+12   | 60 sec intraset; 120 sec | 65% = 215; 225 for "hypertrophy" |
| ==**B1) Hatfield Split Squats**==                                                               | ==3x8==              | ==30 sec==                   | ==195 lbs==                          |
| ==**B2) Landmine Meadows Rows** `with gnarly and strap`==                                      | ==3x8==              | ==120 sec==                  | ==125 lbs==                          |
| *Note: Put band around wrist because pec was bothering me.  Also feels better on shoulders* |                  |                          |                                  |
### Day 3 (12/1/24)
| Exercise                                                                           | Sets x Reps/Time                                                                 | Rest        | Weight     |
| ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------- | ---------- |
| **A1) Viking Press** `inside vertical grip; landmine in low position`              | Work up to ~6 RM<br>8@225 `not including weight of barbell or viking attachment` | 120-180 sec | Find 6 RM  |
| **B1) Belt Squat**                                                                 | Work up to ~10 RM<br>10@310                                                      | 30 sec      | Find 10 RM |
| **B2) Weighted Pullups** `paddle handles, 2 red bands on feet`                     | Work up to ~10 RM<br>9@53                                                        | 60 sec      | Find 10 RM |
| *Notes: Viking: 235 is estimated 6RM<br>Belt Squat: 310<br>Pullups: stick with 53* |                                                                                  |             |            |
### Day 4

| Exercise                                                     | Sets x Reps/Time                                 | Rest    | Weight               |
| ------------------------------------------------------------ | ------------------------------------------------ | ------- | -------------------- |
| **A1) Mid grip Barbell Floor Press** `with Fat Grips`        | Find 1 RM: 315                                   | 3-5 min | 315 lbs              |
| **B1) Overhead tricep extensions**                           | 3x15+ `AMRAP last set`<br>Last set reps here: 26 | 30 sec  | 1 blue + 2 red bands |
| **B2) Seated pseudo face pull** `paddle grip`                | 3x15+ `AMRAP last set`<br>Last set reps here: 27 | 30 sec  | 130 lbs + chain      |
| **B3) GHD leg curls** `with 2 red bands`                     | 3x15+ `AMRAP last set`<br>Last set reps here: 16 | 60 sec  | 10 lbs +2 bands      |
| *Notes: Stopped at 315...struggle and started cramping bad.* |                                                  |         |                      |

### Day 5 

| Exercise                                                             | Sets x Reps/Time | Rest                     | Weight                           |
| -------------------------------------------------------------------- | ---------------- | ------------------------ | -------------------------------- |
| **A1) Flat Bench Press** `red band around wrist`                     | 3x3+12           | 60 sec intraset; 120 sec | 65% = 215; 225 for "hypertrophy" |
| ==**B1) Hatfield Split Squats**==                                        | ==3x10 / leg==       | ==30 sec==                   | ==195 lbs==                          |
| ==**B2) Landmine Meadows Rows** `with gnarly and strap`==               | ==3x10 / arm==       | ==120 sec==                  | ==125 lbs==                          |
| *Note: Forgot to add band and noticed the difference...a bit harder* |                  |                          |                                  |
...
| Exercise                                                                           | Sets x Reps/Time                                 | Rest    | Weight                 |
| ---------------------------------------------------------------------------------- | ------------------------------------------------ | ------- | ---------------------- |
| **A1) viking horizontal grip push press**                                          | Find 1 RM: 315 + 3 red Bands                     | 3-5 min | 315 lbs + 3 skinny red |
